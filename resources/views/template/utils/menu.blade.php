    ...
    <div x-data="{
        ...
        <div x-show="dropdownOpen" @click.away="dropdownOpen=false"
            ...
            <div
                ...
                <div
                    class="relative  cursor-default select-none  lg:py-0.5  items-center rounded px-2  text-sm outline-none transition-colors focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50">

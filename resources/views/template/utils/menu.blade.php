        ...
        <div x-show="dropdownOpen" @click.away="dropdownOpen=false"
            ...
            <div
                ...
                <a href="{{ Auth::user()->hasRole('Admin') ? route('adminDashboard') : route('alumniDashboard') }}"
                    class="cursor-pointer relative flex cursor-default select-none hover:bg-nature-100 items-center rounded px-2 py-1.5 text-sm outline-none transition-colors data-[disabled]:pointer-events-none data-[disabled]:opacity-50">

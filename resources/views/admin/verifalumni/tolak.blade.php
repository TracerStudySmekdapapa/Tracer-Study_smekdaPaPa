            ...
            <div x-show="modalOpen" x-trap.inert.noscroll="modalOpen" x-transition:enter="ease-out duration-300"
                ...
                <div class="relative ">
                    <div class="">
                        ...
                        <p>tolak alumni dengan nama <span class="text-rose-500 font-semibold">
                                {{ $item->name }}</span> ?</p>



                        <div class="grid grid-cols-3 place-items-center w-full gap-x-3 mt-3 ">
                            <button type="button" @click="modalOpen=false"
                                class="py-2 col-span-2 block text-white w-full rounded-sm font-semibold text-center bg-gray-500">Batal</button>
                            <form action="{{ route('tolakVerifAlumni', $item->id_user) }}" method="POST"
                                ...
                                @csrf
                                <button type="submit"
                                    class=" text-white block font-semibold w-full rounded-sm text-center bg-rose-500">Tolak</button>
                            </form>
                        </div>

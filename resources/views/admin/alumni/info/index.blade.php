<div x-data="{ modalOpen: false }" @keydown.escape.window="modalOpen=false" class="relative z-50 w-auto h-auto">
    ...
    <div @click="modalOpen=true"
        class="max-w-[150px] min-w-[100px] bg-blue-700 cursor-pointer py-0.5 rounded-md ml-auto  mr-10 my-10  flex items-center justify-center space-x-2">
    ...
    <template x-teleport="body">
        <div x-show="modalOpen" class="fixed top-0 left-0 z-[99] flex items-center justify-center w-screen h-screen"
            ...
            <div x-show="modalOpen" x-trap.inert.noscroll="modalOpen" x-transition:enter="ease-out duration-300"
                ...
                <div class="relative ">
                    <div class="">
                        <h1 class=" text-xl mb-5 rounded-md font-bold">Informasi mengenai export ke <span

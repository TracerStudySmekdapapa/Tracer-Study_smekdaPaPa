...
@section('content')
    ...
    <section id="kontak" class="pt-[50px] mb-10">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-x-10 gap-y-10 lg:gap-y-0">
                    ...
                    <div class="gap-y-4 grid grid-cols-1">
                        ...
                        <div class="flex justify-start items-center space-x-3">
                            <div class="min-w-[40px] max-w-[45px] aspect-square shadow-md p-2 rounded-lg">
                                <img src="public/assets/email.svg" alt="email" class="w-full h-full" />
                            </div>
                        ...
                        <div class="flex justify-start items-center space-x-3">
                            <div class="min-w-[40px] max-w-[45px] aspect-square shadow-md p-2 rounded-lg">
                                <img src="public/assets/talp.svg" alt="email" class="w-full h-full" />
                            </div>
                        ...
                        <div class="flex justify-start items-center space-x-3">
                            <div class="min-w-[40px] max-w-[45px] aspect-square shadow-md p-2 rounded-lg">
                                <img src="public/assets/lokasi.svg" alt="email" class="w-full h-full" />
                            </div>
            ...
            <div class="w-full h-[90vh] rounded-md overflow-hidden shadow-lg p-3">
